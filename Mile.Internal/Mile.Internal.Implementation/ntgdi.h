...
LONG
NTAPI
ZwGdiSetDIBitsToDeviceInternal(
    _In_ HDC hdcDest,
    _In_ LONG xDst,
    _In_ LONG yDst,
    _In_ ULONG cx,
...
BOOL
NTAPI
ZwGdiGetFontResourceInfoInternalW(
    _In_reads_(cwc) PWSTR pwszFiles,
    _In_ ULONG cwc,
    _In_ ULONG cFiles,
    _In_ ULONG cjIn,
...
ULONG
NTAPI
ZwGdiGetOutlineTextMetricsInternalW(
    _In_ HDC hdc,
    _In_ ULONG cjotm,
    _Out_writes_bytes_opt_(cjotm) OUTLINETEXTMETRICW *potmw,
    _Out_ TMDIFF *ptmd
...
HBRUSH
NTAPI
ZwGdiCreatePatternBrushInternal(
    _In_ HBITMAP hbm,
    _In_ BOOL bPen,
    _In_ BOOL b8X8
    );
...
HBITMAP
NTAPI
ZwGdiCreateBitmapFromDxSurface(
    _In_ HDC hdc,
    _In_ ULONG uiWidth,
    _In_ ULONG uiHeight,
    _In_ ULONG Format,
...
HBITMAP
NTAPI
ZwGdiCreateBitmapFromDxSurface2(
    _In_ HDC hdc,
    _In_ ULONG uiWidth,
    _In_ ULONG uiHeight,
    _In_ ULONG Format,
...
HANDLE
NTAPI
ZwGdiBRUSHOBJ_hGetColorTransform(
    _In_ BRUSHOBJ *pbo
    );
...
ULONG
NTAPI
ZwGdiFONTOBJ_cGetAllGlyphHandles(
    _In_ FONTOBJ *pfo,
    _Out_writes_opt_(return) HGLYPH *phg
    );
...
PVOID
NTAPI
ZwGdiFONTOBJ_pvTrueTypeFontFile(
    _In_ FONTOBJ *pfo,
    _Out_ ULONG *pcjFile
    );
...
BOOL
NTAPI
ZwGdiSTROBJ_bEnumPositionsOnly(
    _In_ STROBJ *pstro,
    _Out_ ULONG *pc,
    _Outptr_result_buffer_(*pc) PGLYPHPOS *ppgpos
    );
...
HANDLE
NTAPI
ZwGdiXLATEOBJ_hGetColorTransform(
    _In_ XLATEOBJ *pxlo
    );
...
NTSTATUS
NTAPI
ZwGdiPATHOBJ_vEnumStartClipLines(
    _In_ PATHOBJ *ppo,
    _In_ CLIPOBJ *pco,
    _In_ SURFOBJ *pso,
    _In_ LINEATTRS *pla
...
NTSYSCALLAPI
BOOL
NTAPI ZwGdiMakeObjectUnXferable(
    _In_ HANDLE h
    );
...
NTSTATUS
NTAPI
ZwGdiDdNotifyFullscreenSpriteUpdate(
    _In_ HDC hdc,
    _In_ HANDLE hSprite
    );
...
NTSTATUS
NTAPI
ZwGdiDdDestroyFullscreenSprite(
    _In_ HDC hdc,
    _In_ HANDLE hSprite
    );
...
NTSYSCALLAPI
BOOL
NTAPI ZwGdiHLSurfGetInformation(
    _In_ HLSURF hLsurf,
    _In_ HLSURF_INFORMATION_CLASS InformationClass,
    _In_reads_bytes_opt_(*pulInformationLength) PVOID InformationBuffer,
    _Inout_ PULONG pulInformationLength
...
ULONG
NTAPI
ZwGdiGetPublicFontTableChangeCookie(
    VOID
    );
...
NTSTATUS
NTAPI
ZwGdiEnsureDpiDepDefaultGuiFontForPlateau(
    _In_ LONG iDpi
    );
