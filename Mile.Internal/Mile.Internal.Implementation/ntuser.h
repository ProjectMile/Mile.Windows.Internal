...
BOOL
NTAPI
ZwUserCanCurrentThreadChangeForeground(
    VOID
    );
...
BOOL
NTAPI
ZwUserCalculatePopupWindowPosition(
    _In_ const POINT* anchorPoint,
    _In_ const SIZE* windowSize,
    _In_ ULONG flags,
    _Inout_ RECT* excludeRect,
...
NTSTATUS
NTAPI
ZwUserCheckAccessForIntegrityLevel(
    _In_ ULONG ProcessIdFirst,
    _In_ ULONG ProcessIdSecond,
    _Out_ PBOOLEAN GrantedAccess
    );
...
NTSTATUS
NTAPI
ZwUserCheckProcessForClipboardAccess(
    _In_ ULONG ProcessId,
    _Out_ PULONG GrantedAccess
    );
...
BOOL
NTAPI
ZwUserDisableProcessWindowFiltering(
    VOID
    );
#endif
...
NTSTATUS
NTAPI
ZwUserGetProcessUIContextInformation(
    _In_ HANDLE ProcessHandle,
    _Out_ PPROCESS_UICONTEXT_INFORMATION UIContext
    );
...
HWND
NTAPI
ZwUserGhostWindowFromHungWindow(
    _In_ HWND WindowHandle
    );
...
HWND
NTAPI
ZwUserHungWindowFromGhostWindow(
    _In_ HWND WindowHandle
    );
...
NTSTATUS
NTAPI
ZwUserSetChildWindowNoActivate(
    _In_ HWND WindowHandle
    );
...
NTSTATUS
NTAPI
ZwUserSetProcessWin32Capabilities(
    _In_reads_(Count) const USER_PROCESS_CAP_ENTRY* Capabilities,
    _In_ ULONG Count
    );
...
NTSTATUS
NTAPI
ZwUserSetProcessRestrictionExemption(
    _In_ BOOL EnableExemption
    );
...
BOOL
NTAPI
ZwUserGetCurrentInputMessageSource(
    _Inout_ INPUT_MESSAGE_SOURCE* InputMessageSource
    );
...
BOOL
NTAPI
ZwUserGetDisplayAutoRotationPreferences(
    _In_ ORIENTATION_PREFERENCE* pOrientation
    );
...
BOOL
NTAPI
ZwUserGetLayeredWindowAttributes(
    _In_ HWND WindowHandle,
    _Out_opt_ COLORREF* Key,
    _Out_opt_ PBYTE Alpha,
    _Out_opt_ PULONG Flags
...
ULONG
NTAPI
ZwUserGetRegisteredRawInputDevices(
    _Out_opt_ PRAWINPUTDEVICE RawInputDevices,
    _Inout_ PULONG RawInputDeviceCount,
    _In_ ULONG RawInputDeviceSize
    );
...
HWND
NTAPI
ZwUserRealChildWindowFromPoint(
    _In_ HWND WindowHandleParent,
    _In_ POINT ptParentClientCoords
    );
...
BOOL
NTAPI
ZwUserSetLayeredWindowAttributes(
    _In_ HWND WindowHandle,
    _In_ COLORREF Key,
    _In_ BYTE Alpha,
    _In_ ULONG Flags
...
BOOL
NTAPI
ZwUserRegisterCloakedNotification(
    _In_ HWND WindowHandle,
    _In_ BOOL Register
    );
...
NTSTATUS
NTAPI
ZwUserSetForegroundWindowForApplication(
    _In_ HWND WindowHandle
    );
...
HWND
NTAPI
ZwUserShellForegroundBoostProcess(
    _In_ HANDLE ProcessHandle,
    _In_ HWND WindowHandle
    );
...
ULONG
NTAPI
ZwUserSetAdditionalForegroundBoostProcesses(
    _In_ HWND WindowHandle
    );
...
ULONG
NTAPI
ZwUserSetAdditionalPowerThrottlingProcess(
    _In_ HWND WindowHandle,
    _In_ ULONG ProcessHandlesCount,
    _In_reads_(ProcessHandlesCount) PHANDLE ProcessHandles
    );
...
BOOL
NTAPI
ZwUserShutdownBlockReasonQuery(
    _In_ HWND WindowHandle,
    _Out_ PWSTR Buffer,
    _Inout_ PULONG BufferCount
    );
...
LOGICAL
NTAPI
ZwUserAllowForegroundActivation(
    VOID
    );
...
LOGICAL
NTAPI
ZwUserCancelQueueEventCompletionPacket(
    VOID
    );
...
LOGICAL
NTAPI
ZwUserDisableProcessWindowsGhosting(
    VOID
    );
...
LOGICAL
NTAPI
ZwUserDrainThreadCoreMessagingCompletions(
    VOID
    );
...
ULONG
NTAPI
ZwUserGetUnpredictedMessagePos(
    VOID
    );
...
LOGICAL
NTAPI
ZwUserHandleSystemThreadCreationFailure(
    VOID
    );
...
LOGICAL
NTAPI
ZwUserReassociateQueueEventCompletionPacket(
    VOID
    );
...
LOGICAL
NTAPI
ZwUserUpdatePerUserImmEnabling(
    VOID
    );
...
LOGICAL
NTAPI
ZwUserEnableMouseInPointerForThread(
    VOID
    );
...
LOGICAL
NTAPI
ZwUserEnablePerMonitorMenuScaling(
    VOID
    );
...
LOGICAL
NTAPI
ZwUserAllowSetForegroundWindow(
    _In_ ULONG ProcessId
    );
...
LOGICAL
NTAPI
ZwUserEnsureDpiDepSysMetCacheForPlateau(
    _In_ ULONG Dpi
    );
...
UINT_PTR
NTAPI
ZwUserForceEnableNumpadTranslation(
    _In_ LOGICAL ForceNumlockTranslation
    );
...
LOGICAL
NTAPI
ZwUserSetShellChangeNotifyHWND(
    _In_ HWND hwnd
    );
...
LOGICAL
NTAPI
ZwUserDeregisterShellHookWindow(
    _In_ HWND hwnd
    );
...
ULONG_PTR
NTAPI
ZwUserDWP_GetEnabledPopupOffset(
    _In_ HWND hwnd
    );
...
ULONG_PTR
NTAPI
ZwUserInitThreadCoreMessagingIocp(
    _In_ HWND hwnd
    );
...
LOGICAL
NTAPI
ZwUserScheduleDispatchNotification(
    _In_ HWND hwnd
    );
...
LOGICAL
NTAPI
ZwUserRegisterWindowArrangementCallout(
    _In_ HWND hwnd,
    _In_ LOGICAL Register
    );
...
LOGICAL
NTAPI
ZwUserEnableModernAppWindowKeyboardIntercept(
    _In_ HWND hwnd,
    _In_ LOGICAL Enable
    );
...
LOGICAL
NTAPI
ZwUserCheckImeShowStatusInThread(
    _In_ HWND Ime
    );
...
LOGICAL
NTAPI
ZwUserSetCancelRotationDelayHintWindow(
    _In_ HWND hwnd
    );
...
LOGICAL
NTAPI
ZwUserBroadcastImeShowStatusChange(
    _In_ HWND Ime,
    _In_ LOGICAL Show
    );
...
LOGICAL
NTAPI
ZwUserChangeWindowMessageFilter(
    _In_ ULONG Message,
    _In_ ULONG Flag // MSGFLT_* WinUser.h
    );
...
LOGICAL
NTAPI
ZwUserNlsKbdSendIMENotification(
    _In_ ULONG ImeOpen,
    _In_ ULONG ImeConversion
    );
...
LOGICAL
NTAPI
ZwUserRegisterSiblingFrostWindow(
    _In_ HWND hwndFrost,
    _In_ HWND hwnd
    );
...
LOGICAL
NTAPI
ZwUserRegisterUserHungAppHandlers(
    _In_ PFNW32ET W32EndTask,
    _In_ HANDLE EventWowExec
    );
...
LOGICAL
NTAPI
ZwUserEnableShellWindowManagementBehavior(
    _In_ ULONG_PTR Param1,
    _In_ ULONG_PTR Param2
    );
...
ULONG_PTR
NTAPI
ZwUserScaleSystemMetricForDPIWithoutCache(
    _In_ ULONG Metric,
    _In_ ULONG ToDpi
    );
